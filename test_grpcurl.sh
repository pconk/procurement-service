...
# Alamat server gRPC Quarkus (default port 50054)
SERVER="localhost:50054"

# Token valid untuk secret: rahasia-super-aman
TOKEN2="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3NzU1ODIxNTYsImlzcyI6ImF1ZGl0LXNlcnZpY2UtdGVzdCIsInJvbGUiOiJhZG1pbiIsInVzZXJfaWQiOiIxIiwidXNlcm5hbWUiOiJhZG1pbl9ndWRhbmciLCJ3YXJlaG91c2VfaWQiOiJXSC1KS1QtMDk5In0.3AORr8dER7JV0lXGxMDTRUar8KHpKFq7ZvkXWvW7XU4"
# expired
